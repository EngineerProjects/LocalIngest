...
\begin{description}
    \item[ADC (Advanced Data \& Climate)] : Équipe d'Allianz France spécialisée en data management et modélisations. Équipe d'accueil du projet.
    ...
    \item[P4D] : Direction d'Allianz France regroupant plusieurs pôles et équipes data, dont l'équipe ADC.
