...
\begin{figure}[H]
    ...
    \caption{Organigramme de l'unité ABR, direction P4D et pôle Advanced Data \& Climate}
...
La mission s'est déroulée au sein de l'équipe Transversal Data projects, qui intervient de manière transverse sur des projets data (MicroStrategy, projets avec le groupe et avec l'IT) et a également en charge certains datamarts autour des branches Pro Midcorp. Contrairement au pôle Data Management spécialisé dans les univers Retail et Sinistres, l'équipe d'accueil ne réalise pas de modélisation actuarielle, mais se concentre sur l'ingénierie des données et la gestion des flux.

\section{Contexte stratégique : le projet SAS EXIST}

De nombreux datamarts d'Allianz France (bien au-delà de la seule direction P\&C) fonctionnent aujourd'hui sur une infrastructure SAS en place depuis de nombreuses années (SAS Institute Inc., 2023). Ce système a bien servi l'entreprise, mais il présente désormais des limites difficiles à ignorer : coûts de licences propriétaires élevés, performances contraintes par des serveurs vieillissants, code difficile à maintenir faute de documentation, et expertise SAS de plus en plus rare sur le marché du travail. Pendant ce temps, Python et l'écosystème cloud sont devenus les standards du data engineering.
...
\begin{itemize}
    \item \textbf{Technique} : analyser et transposer près de 15\,000 lignes de code SAS réparties dans dix-neuf fichiers hétérogènes, pour la plupart non documentés et comportant de nombreuses dépendances implicites ;
