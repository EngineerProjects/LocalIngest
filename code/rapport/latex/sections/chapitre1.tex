...
\begin{itemize}
    ...
    \item \textbf{Architecturale} : concevoir une architecture médaillon (Bronze / Silver / Gold) adaptée aux spécificités du marché Construction et généralisable aux autres marchés ;
    ...
    \item \textbf{Documentation} : produire des livrables durables, documentation SAS, règles métier, code Python, qui serviront de référence aux équipes après le stage.
\end{itemize}
