...
\begin{description}
    ...
    \item[P\&C (Property \& Casualty)] : Assurance des biens et responsabilités (Construction, Auto, Habitation, Santé, Épargne).
    \item[PE (Perte d'Exploitation)] : Capital assuré couvrant les pertes financières consécutives à un sinistre.
    \item[PTF (Portefeuille)] : Ensemble des polices en vigueur à une date donnée.
...
\begin{description}
    \item[ADC (Advanced Data \& Climate)] : Pôle d'Allianz France spécialisé en data management et modélisations. Équipe d'accueil du stage.
