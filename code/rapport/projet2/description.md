...
PLANNING INDICATIF (2 mois)
----------------------------

Semaines 1-2  : Exploration et cadrage technique
               - Récupérer le travail existant de Yanis sur les adresses (via Lionel).
               - Analyser la structure exacte des fichiers CSV.
               - Définir les règles de validation précises.

Semaines 3-5  : Développement des vérifications Priorité 1
               - Adresses, codes postaux, coordonnées GPS.

Semaines 6-7  : Développement Priorité 2 et génération du fichier Excel
               - Capitaux / superficie + construction du rapport de sortie.

Semaine 8     : Tests, corrections et documentation
               - Tests sur données réelles, documentation pour la passation.